...
void Control_inv_mass(){
    ...
    TString lumi[5]={"0.25", "0.15", "0.29", "0.90", "0.16"};
    TString lumi_tot="1.75";
...
void Fit_each_era(TString name[], TString lumi[], TString lumi_tot){
    unsigned int y[5][3]={{1500,300,18000},{1000,250,8000},{2500,650,20000},{7000,1800,60000},{800,180,10000}};
    float par[2]={1.,1.};
