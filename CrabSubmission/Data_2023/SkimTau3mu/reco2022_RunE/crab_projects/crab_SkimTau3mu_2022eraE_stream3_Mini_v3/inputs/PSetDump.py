...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it///store/data/Run2022G/ParkingDoubleMuonLowMass5/MINIAOD/PromptReco-v1/000/362/437/00000/645c4ac6-81f3-4c9d-9e29-21934c2ff83c.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('124X_dataRun3_v14'),
...
process.ThreeMuonSelSeq = cms.Sequence(process.InitialPlots+process.PlotsAfterTrigger+process.looseMuons+process.PlotsAfterLooseMuon+process.ThreeMuonsFilter+process.PlotsAfter3Muons+process.ThreeMuonsCand+process.ThreeMuonsCandFilter+process.PlotsAfterTauCand+process.ThreeMuonsVtxKalmanFit)


process.Tau3MuSkim = cms.Path(process.ThreeMuonSelSeq+process.unpackedPatTrigger+process.TreeMakerBkg)
